    ...
    , ui(new Ui::Dialog)
{
    ...
    start->setMedia(QUrl::fromLocalFile("./files/music/win2000.mp3"));
    BGM->setMedia(QUrl::fromLocalFile("./files/music/Funky Star.mp3"));
    win->setMedia(QUrl::fromLocalFile("./files/music/win3.1.mp3"));
    lost->setMedia(QUrl::fromLocalFile("./files/music/th03_OVER.mp3"));
    ...
    ui->spinBox_2->setMaximum(19);//设置最大值
...
void Dialog::on_tableWidget_cellDoubleClicked(int row,int column)//右键格子
{
...
void Dialog::on_spinBox_2_valueChanged(int arg1)//动态根据场地大小改变自定义雷数的最大值
{
